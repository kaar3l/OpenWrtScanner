...
ssh "$ROUTER" "chmod +x $REMOTE_DIR/cgi-bin/scan.py $REMOTE_DIR/cgi-bin/download.py $REMOTE_DIR/cgi-bin/history.py $REMOTE_DIR/cgi-bin/thumb.py $REMOTE_DIR/cgi-bin/progress.py $REMOTE_DIR/cgi-bin/delete.py"
